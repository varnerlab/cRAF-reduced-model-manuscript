...
\subsubsection*{Cell cycle arrest.}
A defining feature of ATRA-induced differentiation is cell cycle arrest.
We did not include a description of the restriction point logic, however, we do have a model of E2F transcription.
We developed a heuristic 
