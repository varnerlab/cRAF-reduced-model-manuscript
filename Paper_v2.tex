...
single ($\Delta$Gfi-1 or $\Delta$PPARg) and double ($\Delta$Gfi-1 and $\Delta$PPARg) mutants for the best fit parameter set (Fig. \ref{fig:model-response-ko-simulations}).
...
Analysis of the signal integration and phenotype modules suggested that Gfi-1 and PPARg regulated distinct phenotypic axes following ATRA exposure.
The most significantly unregulated protein in the $\Delta$Gfi-1 mutant was the PU.1 protein.
PU.1, a member of the ets transcription factor family, is a well known regulatory protein in granulocyte and monocyte development \cite{Friedman2007}.
The relative level of PU.1 and C/EBPa is thought to regulate macrophage versus neutrophil cell fate decisions in granulocytic macrophage progenitor cells \cite{Dahl2003}.
However, in previous studies we showed that PU.1 has additional non-canonical function as it is highly expressed following the addition of ATRA to HL-60 cells.
Analysis of the model in this study suggested that the C/EBPa dependent interaction of PU.1 with the \textit{NCF1} gene, which encodes for the p47Phox protein, was the most sensitive PU.1 connection.
p47Phox, also known as neutrophil cytosol factor 1, is one of four cytosolic subunits of the multi-protein NADPH oxidase complex found in neutrophils \cite{El-Benna:2009aa}.
This enzyme is responsible for reactive oxygen species (ROS) production, a key component of the anti-microbial function of neutrophils.
PU.1 also acted in concert with the activator protein 1 (AP-1) transcription factor to regulate p21 expression, a second phenotypic outcome of ATRA-induced differentiation.
The AP-1 transcription factor regulates gene expression in response to a variety of stimuli.
However, in the context of ATRA-induced differentiation, AP1 has been shown to be inhibited in
