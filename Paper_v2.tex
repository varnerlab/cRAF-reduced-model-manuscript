...
However, the bulk of the remaining model parameters were taken from directly from literature [REFHERE] and were not estimated from data in this study (see materials and methods).
