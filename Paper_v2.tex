...
\vspace{0.05in}
{\par \centering \large{Ryan Tasseff, Holly A. Jensen, Johanna Congleton$^{\dag}$, Wei Dai, Andrew Yen$^{\dag}$, and Jeffrey D. Varner$^{*}$}}
\vspace{0.10in}
...
Of the 19 proteins sampled, Vav1, Src, CK2, Akt, and 14-3-3 precipitated with Raf,
