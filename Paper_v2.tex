...
\section*{Results}
We constructed an effective model of the ATRA-induced HL-60 differentiation which described signaling and gene expression events following the addition of ATRA (Fig. \ref{fig:network}).
...
a signal initiation module that was responsible for sensing and transforming the ATRA signal into activated cRaf-S621 and the ATRA-RXR/RAR (Trigger) signals (Fig. \ref{fig:network}A);
a signal integration module that controlled the expression of upstream transcription factors given cRaf-S621 and activated Trigger (Fig. \ref{fig:network}B); and
a phenotype module which encoded the expression of functional differentiation markers (Fig. \ref{fig:network}C).
