...
%Understanding differentiation programs is an important therapeutic challenge.
...
The ATRA differentiation model was encoded as a system of differential algebraic equations (DAEs) which described signaling and gene expression processes.
...
\topcaption{Sequence lengths from NCBI RefSeq database were used in the signal integration and phenotype modules \cite{OLeary:2016aa}.
